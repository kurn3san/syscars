...
<div id="contact" style=" display:flex; flex-direction:column; flex:1; margin:200px;">
<h1 style="text-align: left;">Signup</h1>
    ...
    ?>
    <form action="includes/signup.inc.php" method='post' id="contact-form" enctype="multipart/form-data" style="display:flex; flex-direction:column; ">
